...
import { REAL_ROOT, SYNTHETIC_ROOT, CHIEF_PIN, PROVIDER_ALLOCATION, SOURCE_CANDIDATE } from './runner.mjs';
...
console.log(`capture   ${capture.checks.length - capture.failures.length}/${capture.checks.length} checks passed`);
